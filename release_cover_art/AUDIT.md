...
pins: `cover_art` @ `5f927785…`, `miso` @ `c23fe7f…` (bumped 2026-08-23 from `7c13e40a…`, carrying the `miso_share` treasury-cap hardening `d67ff8c`), `per_track` @
`e1bb40b…` (bumped 2026-08-23 alongside `miso`) (`Move.toml`); audited dependency sources are the on-disk
