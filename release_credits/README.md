...
Added/removed events retain release/admin-cap/party IDs, compact role kind, credit index/counts, and field lifecycle flags. Both are exactly 123 BCS bytes. Display names stay in the stored credit.
